...
public interface ReturnsService {
	...
	public List<Returns> subViewReturnsList(String subCode, Search search, String YN);		//가맹측 반품상품관리 조회
	...
	public List<Returns> headViewReturnsList(Search search,String YN);		//본사측 반품상품관리 조회

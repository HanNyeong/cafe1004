...
public class SubStaffController {
	...
	public String addSubStaff(){
		return "/shared/subStaff/subAddSubStaff";
	}
	...
	public String addSubStaff(Model model, SubStaff subStaff){
		...
		if(subStaff.getSubStaffId() != null){
			// 2-1 아이디를 화면에 보여줄거임
	...
	public String viewSubStaffList(Model model,SubStaffSearch subStaffSearch){
		...
		return "/shared/subStaff/viewSubStaffList";
	}
	...
	/**
	   ...
	   public String subModifySubStaff(Model model,SubStaff subStaff){
	      ...
	      return "/shared/subStaff/subModifySubStaff";
	   }
	   /**
	   ...
	   public String subModifySubStaffPost(Model model,SubStaff subStaff){
	      ...
	      if(subStaffService.subModifySubStaffService(subStaff) == 0){
	    	  model.addAttribute("subStaff",subStaff);
	    	  result = "/shared/subStaff/subModifySubStaff";
	      }else{
	   ...
	   public String loginSubStaff(Model model ,SubStaff subStaff){
		   System.out.println("SubStaffController loginSubStaff실행");
//		   String result = "";
	   ...
	   @RequestMapping(value="logout",method=RequestMethod.GET)
		public String logout(@ModelAttribute SubStaff subStaff,SessionStatus status){
			status.setComplete();
			return "redirect:/";
		}
	   /**

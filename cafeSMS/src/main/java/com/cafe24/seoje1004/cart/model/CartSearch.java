...
public class CartSearch {
	...
	public String getSearchCart() {
		return searchCart;
	}
	public void setSearchCart(String searchCart) {
		this.searchCart = searchCart;
	}
	@Override
	public String toString() {
		return "CartSearch [upDown=" + upDown + ", criteria=" + criteria + ", regitDateStart=" + regitDateStart
				+ ", regitDateEnd=" + regitDateEnd + ", searchKey=" + searchKey + ", searchCart=" + searchCart + "]";
	}

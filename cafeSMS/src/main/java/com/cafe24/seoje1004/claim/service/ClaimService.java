...
public interface ClaimService {
	...
	public List<Claim> headViewClaimList(Search claimSearch);		//본사가 전체클래임리스트 조회
	...
	public List<Claim> subViewClaimList(String subCode, Search claimSearch);	//가맹이 해당점의 클래임리스트 조회
	...
	public List<Claim> customerViewClaimList(Claim claim, Search claimSearch);	//고객이 자신의 클래임을 조회, 검색 및 정렬기능 추가

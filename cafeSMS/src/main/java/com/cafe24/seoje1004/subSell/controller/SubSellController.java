...
import com.cafe24.seoje1004.util.Search2;
...
public class SubSellController {
	...
	public String subViewSubSellList(Model model, Search search, @RequestParam(value="subCode")String subCode, Search2 search2){

...
<body>
	...
	<c:if test="${customerName != null}">	
		<div>
			<!-- 수정후 콘텐츠(가맹이접근한)로 돌아가야하는데 매개변수로 claimCode와 customerName이 필요 -->
			<a href="/customerUpdateClaimForm?claimCode=${map.claimContent.claimCode}&customerName=${map.claimContent.customerName}">[수정]</a>
